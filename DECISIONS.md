...
- N32 — Point 14: independent content review of all public-facing copy (Filipino and English) — BLOCKING — gate: launch (HANDOVER pre-launch gates); COPY-REVIEW.md (every on-screen string, verbatim, by screen, with file:line; snapshot of d66146c) is ready for reviewers; no review has started
