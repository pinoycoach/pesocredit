...
(8dcd45b): all three sign-offs are in and `launch-check` passes. Open: the Netlify banner (N46),
a bug to fix after launch. The full privacy page with counsel (N17) and the checklist (N37) wait
for the email form. Every step group stops for review.
